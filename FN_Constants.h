...
//const double startime = INSERT_STARTTIME;       //total time of simulation (simulation units)
//const double CurvePrintTime = INSERT_PRINTTIME; // print out the knot , without the velocity
